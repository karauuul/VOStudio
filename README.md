...
- `src/renderer/` — React UI and audio engine.
  ...
  - Import room: `import/SourcesPanel.tsx`, `import/LinesTable.tsx`, `import/ProjectPanel.tsx`. Export room: `export/OutputPanel.tsx`, `export/ReadinessTable.tsx`, `export/SummaryPanel.tsx`, `export/run-export.ts` (`runJob` / `runPlan`).
